...
def save_images(webpage, visuals, image_path, aspect_ratio=1.0, width=256):
    ...
    folder = os.path.split(os.path.split(os.path.split(image_path[0])[0])[0])[1]
    category = os.path.split(os.path.split(os.path.split(os.path.split(image_path[0])[0])[0])[0])[1]
    name = os.path.splitext(short_path)[0]
    name = str(category) + '_' + str(folder) + '_' + name
